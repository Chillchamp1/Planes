...
basemap's wide frame needs -- it comes to 180,000+ points, most of it coastal
wiggle invisible at the zoom level this map actually renders at. The outline
(Germany, filled) keeps a little more detail than the neighbours (thin
border lines only), hence two tolerances.
"""
